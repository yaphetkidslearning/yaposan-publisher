...
const workspaces: Workspace[] = [
  {
    title: "Publisher",
    description: "Professional layouts for flyers, brochures, books, labels, business cards, and more.",
  ...
  {
    title: "Photo Studio",
    description: "Remove backgrounds, retouch, relight, upscale, and create stunning product images.",
    icon: "image-outline",
    href: "/photo-studio",
    accent: "#2563eb",
    dark: "#1743bd",
  ...
  {
    title: "Yaposan AI",
    description: "AI writing, design suggestions, image generation, translation, and document assistance.",
    icon: "sparkles",
    href: "/ai",
    accent: "#9333ea",
    dark: "#6b21a8",
          ...
          <View style={[styles.topShowcase, mobile && styles.topShowcaseMobile]}>
            <View style={styles.iHeader}>
              ...
              <View style={styles.iHeaderActions}>
                ...
                <Pressable style={styles.iIconButton}><Ionicons name="notifications-outline" size={21} color={darkMode ? "#dcecff" : "#122236"} /></Pressable>
...
const styles = StyleSheet.create({
  ...
  scroll: { flex: 1 },
  sidebar: { width: 220, backgroundColor: "#071b2e", paddingHorizontal: 14, paddingVertical: 18, borderRightWidth: 1, borderRightColor: "#15324a" },
  ...
  sidebarSectionLabel: { flex: 1, color: "#d6e2ee", fontSize: 13, fontWeight: "800" },
