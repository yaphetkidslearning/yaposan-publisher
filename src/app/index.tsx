      ...
      <ScrollView contentContainerStyle={s.page}>
        <View style={[s.nav, compact && s.navCompact]}>
          ...
          <View style={[s.navActions, compact && s.navActionsCompact]}>
            <Pressable onPress={()=>router.push("/create-ai-page")}><Text style={s.navLink}>AI Page</Text></Pressable>
            ...
            <Pressable onPress={()=>router.push("/sign-in")}><Text style={s.navLink}>Sign In</Text></Pressable>
          </View>
        </View>
        ...
        <View style={[s.hero, compact && s.heroCompact]}>
          <View style={s.heroCopy}>
            ...
            <Text style={[s.title, compact && s.titleCompact]}>Create your own AI-powered page on the internet.</Text>
            <Text style={s.lead}>Create a personal AI page, connect your preferred AI provider, publish content, communicate with followers, and use built-in creative tools — all from one space.</Text>
            <View style={[s.actions, compact && s.actionsCompact]}>
              <Pressable style={s.primary} onPress={()=>router.push("/create-ai-page")}><Ionicons name="sparkles" size={20} color="#fff"/><Text style={s.primaryText}>Create My AI Page</Text></Pressable>
