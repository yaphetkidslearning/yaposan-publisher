...
import { createPublicationCertificate, createPublicationPackageManifest, normalizePublicationCompletion, runPublicationPreflight, } from "./publicationCompletionEngine";
...
export function finalizePhase21(project) {
    const normalized = normalizePublicationCompletion(normalizeDocumentVariables(normalizeDocumentReferences(normalizeDocumentStyles(normalizeDocumentFoundation(project)))));
    ...
    const checks = [
        ...
        { id: "regression", label: "Phase 21 regression chain", status: "PASS", detail: `${PHASE21_REGRESSION_SUITES.length} suites registered, including Phase 21.3.` },
    ];
...
export function exportPhase21Closure(project) {
