...
export const PHASE31_MODULES: Phase31Module[] = [
  ...
  { id: "31.11", title: "Production Integration", description: "Connect services to navigation, studios and shared state.", features: ["Sidebar Integration", "Ribbon Integration", "Studio Integration", "Shared Queue", "Shared Assets", "Shared Export Center"] },
