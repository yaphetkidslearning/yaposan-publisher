...
export const PHASE41_CONTROLS:Phase41Control[]=[
 ...
 {id:"41.12",area:"Certification",title:"Evidence-backed production certification",status:"not-started",automated:true,requiredEvidence:["test-report","security-report","artifact-hash","health-check","approval"]}
];
