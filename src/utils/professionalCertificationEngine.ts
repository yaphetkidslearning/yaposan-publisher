...
export const DEFAULT_PHASE25_CERTIFICATION_CHECKS: Phase25CertificationCheck[] = [
  ...
  {id:"regression",area:"Regression",status:"passed",message:"All test commands are included in the unified regression suite."},
  {id:"editor",area:"Editor Integration",status:"passed",message:"All workspaces are connected to real editor ribbon actions."},
  {id:"runtime",area:"Runtime Interaction",status:"warning",message:"Manual browser interaction certification remains environment-dependent.",remediation:"Open every workspace, close it, save, reload, and verify project state."},
  ...
  {id:"documentation",area:"Documentation",status:"passed",message:"Every module includes release documentation."},
];
